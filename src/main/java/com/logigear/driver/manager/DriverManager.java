...
public class DriverManager {
    ...
    protected static void removeKey() {
        if (isKeyExist(curKey)) {
            DRIVER.get().remove(curKey);
        }
    }
    ...
    public static DriverProperty getCurrentProperty() {
        return (DriverProperty)tmpProperty.get();
    }

    public void setCurrentProperty(DriverProperty property) {
        tmpProperty.set(property);
    }
